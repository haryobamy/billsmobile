...
const mtn = require("../assets/icons/mtn.jpg");
const airtel = require("../assets/icons/airtel.jpg");
const glo = require("../assets/icons/glo.jpg");
const smile = require("../assets/icons/smile.jpg");
